...
exports.updateTask = exports.saveTask = exports.getUser = exports.getTaskByCategory = exports.getAllTasks = exports.deleteUser = exports.deleteTask = exports.createUser = void 0;
var _db = require("../db");
...
var deleteUser = exports.deleteUser = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var userId, connection, _yield$connection$que7, _yield$connection$que8, result;
...
var saveTask = exports.saveTask = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var userId, _req$body3, name, description, creation_date, due_date, category, importance, completed, connection, _yield$connection$que9, _yield$connection$que10, result;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _req$body3 = req.body, name = _req$body3.name, description = _req$body3.description, creation_date = _req$body3.creation_date, due_date = _req$body3.due_date, category = _req$body3.category, importance = _req$body3.importance, completed = _req$body3.completed;
          if (!(!name || !due_date)) {
            _context4.next = 5;
            break;
          }
        ...
        case 7:
          ...
          _context4.next = 10;
          return connection.query("INSERT INTO tasks (name, description, creation_date, due_date, category, importance, completed, user_id) VALUES (?,?,?,?,?,?,?,?)", [name, description, creation_date, due_date, category, importance, completed, userId]);
        case 10:
...
var deleteTask = exports.deleteTask = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var userId, taskId, connection, _yield$connection$que13, _yield$connection$que14, result;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 8:
          ...
          return _context6.abrupt("return", result.affectedRows === 1 ? res.status(200).json({
...
var updateTask = exports.updateTask = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res) {
    var userId, taskId, _req$body4, name, description, creation_date, due_date, category, importance, completed, connection, _yield$connection$que15, _yield$connection$que16, rows, fieldsToUpdate, _yield$connection$que17, _yield$connection$que18, result;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          ...
          userId = req.params.idUser;
          taskId = req.params.idTask;
          _req$body4 = req.body, name = _req$body4.name, description = _req$body4.description, creation_date = _req$body4.creation_date, due_date = _req$body4.due_date, category = _req$body4.category, importance = _req$body4.importance, completed = _req$body4.completed;
          _context7.next = 6;
          return (0, _db.connect)();
        case 6:
...
var getTaskByCategory = exports.getTaskByCategory = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(req, res) {
    var userId, category, connection, _yield$connection$que19, _yield$connection$que20, rows;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        ...
        case 18:
          ...
          console.log('Error en la función getTaskByCategory:', _context8.t0);
  ...
  return function getTaskByCategory(_x15, _x16) {
